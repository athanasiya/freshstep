...
<section class="mt-12 flex flex-col gap-12 max-w-[540px] mx-auto px-5">
    ...
    <div class="flex flex-col gap-8 w-full">
        <h2 class="text-black font-black text-[27.65px] leading-[27.65px]"> Log in to Fresh Step </h2>
        <a href="{{ route('register') }}" class="text-[13.33px] leading-4 text-black opacity-90 underline">
        ...
        <form action="{{ route('login') }}" method="POST" class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-2">
                ...
                <input
                    ...
                    @endif 
                <a class="text-[13.33px] leading-[16px] text-[#000000] opacity-100 underline">
                    Forgot Password?
                </a>
            </div>
            <div class="flex flex-col gap-2">
